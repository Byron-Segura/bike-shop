    ...
    <section className='bg-zinc-900'>
      <article className='h-2/3 p-6 md:p-10 flex flex-col-reverse md:flex-row gap-2 md:gap-12 font-light items-center'>
        <div className='text-slate-200 p-4 py-8'>
          ...
          <p className='text-lg'>All the products in this website are ready for delivery. The delivery service is available worldwide.</p>
          <p>Free delivery in orders above $100 and it will be delivered in a period of 1 or 2 weeks after order the products.</p>
