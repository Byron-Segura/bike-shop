...
export function HomePage () {
  return (
    <div>
      <section>
        <article className='min-h-screen opacity-90 bg-cover bg-center top-0 left-0 -mt-16' style={{ backgroundImage: 'url("../src/assets/home-image-01.jpg")' }}>
          <aside className='min-h-screen bg-black/40 flex flex-col justify-center -mt-32 md:-mt-16'>
            <div className='text-center flex flex-col justify-center items-center gap-8 md:gap-12 text-slate-200 p-8'>
              ...
              <NavLink to='bikes' styles='bg-zinc-900 hover:bg-orange-500 p-20 py-6 font-bold text-xl'>BIKES</NavLink>
            </div>
          </aside>
        </article>
      </section>
