...
export function Footer () {
  return (
    <section className='bg-zinc-900 h-fit md:h-[70vh]'>
      ...
      <div className='relative bottom-0 mt-12 bg-zinc-950 text-zinc-200 flex items-center justify-center p-2 font-extralight text-sm'>
